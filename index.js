...
const allPlanets = document.querySelectorAll('.center > .smallPlanet')
console.log(allPlanets)
allPlanets.forEach(planet => {
    planet.addEventListener('mouseover', stopPlanet(planet))
    })
...
function changeHeader() {
    return header.style.background === 'green' ? header.style.background = 'gray' : header.style.background = 'green'
}
